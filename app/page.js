  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start lg:gap-10 py-20 px-1 lg:px-4 lg:py-10 xl:p-14">
      <div className="z-10 max-w-7xl w-full items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b bg-gradient-to-b pb-6 pt-8 px-2 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4 lg:dark:bg-zinc-800/30">
      ...
      <div className="mb-96 grid text-center lg:max-w-7xl lg:w-full lg:mb-0 md:grid-cols-2 lg:grid-cols-4 lg:text-left my-8">
        <a
          href="/discountCalc"
        ...
        <a
          href="/passwordGen"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:dark:bg-opacity-30"
        >
          <h2
        ...
        >
          <h2
            className={`mb-3 text-2xl font-semibold flex justify-center lg:justify-start items-center gap-1`}
          >
            Not What you need&nbsp; <span className=" whitespace-nowrap"> :(</span>
